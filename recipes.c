...
struct Recipe *getRecipeList() {
	...
	recipes[49].combos[9] = 	parseCombo(2,	Dried_Bouquet,Fresh_Juice);
	recipes[49].combos[10] = 	parseCombo(2,	Dried_Bouquet,Fried_Egg);
	recipes[49].combos[11] = 	parseCombo(2,	Dried_Bouquet,Fruit_Parfait);
	recipes[49].combos[12] = 	parseCombo(2,	Dried_Bouquet,Golden_Leaf);
	recipes[49].combos[13] = 	parseCombo(2,	Dried_Bouquet,Healthy_Salad);
	recipes[49].combos[14] = 	parseCombo(2,	Dried_Bouquet,Heartful_Cake);
	recipes[49].combos[15] = 	parseCombo(2,	Dried_Bouquet,Honey_Candy);
	recipes[49].combos[16] = 	parseCombo(2,	Dried_Bouquet,Honey_Shroom);
	recipes[49].combos[17] = 	parseCombo(2,	Dried_Bouquet,Honey_Super);
	recipes[49].combos[18] = 	parseCombo(2,	Dried_Bouquet,Honey_Ultra);
	recipes[49].combos[19] = 	parseCombo(2,	Dried_Bouquet,Hot_Dog);
	recipes[49].combos[20] = 	parseCombo(2,	Dried_Bouquet,Icicle_Pop);
	recipes[49].combos[21] = 	parseCombo(2,	Dried_Bouquet,Ink_Pasta);
	recipes[49].combos[22] = 	parseCombo(2,	Dried_Bouquet,Inky_Sauce);
	recipes[49].combos[23] = 	parseCombo(2,	Dried_Bouquet,Jammin_Jelly);
	recipes[49].combos[24] = 	parseCombo(2,	Dried_Bouquet,Jelly_Candy);
	recipes[49].combos[25] = 	parseCombo(2,	Dried_Bouquet,Jelly_Shroom);
	recipes[49].combos[26] = 	parseCombo(2,	Dried_Bouquet,Jelly_Super);
	recipes[49].combos[27] = 	parseCombo(2,	Dried_Bouquet,Jelly_Ultra);
	recipes[49].combos[28] = 	parseCombo(2,	Dried_Bouquet,Keel_Mango);
	recipes[49].combos[29] = 	parseCombo(2,	Dried_Bouquet,Koopa_Bun);
	recipes[49].combos[30] = 	parseCombo(2,	Dried_Bouquet,Koopa_Tea);
	recipes[49].combos[31] = 	parseCombo(2,	Dried_Bouquet,Koopasta);
	recipes[49].combos[32] = 	parseCombo(2,	Dried_Bouquet,Life_Shroom);
	recipes[49].combos[33] = 	parseCombo(2,	Dried_Bouquet,Love_Pudding);
	recipes[49].combos[34] = 	parseCombo(2,	Dried_Bouquet,Mango_Delight);
	recipes[49].combos[35] = 	parseCombo(2,	Dried_Bouquet,Maple_Shroom);
	recipes[49].combos[36] = 	parseCombo(2,	Dried_Bouquet,Maple_Super);
	recipes[49].combos[37] = 	parseCombo(2,	Dried_Bouquet,Maple_Syrup);
	recipes[49].combos[38] = 	parseCombo(2,	Dried_Bouquet,Maple_Ultra);
	recipes[49].combos[39] = 	parseCombo(2,	Dried_Bouquet,Meteor_Meal);
	recipes[49].combos[40] = 	parseCombo(2,	Dried_Bouquet,Mistake);
	recipes[49].combos[41] = 	parseCombo(2,	Dried_Bouquet,Mousse_Cake);
	recipes[49].combos[42] = 	parseCombo(2,	Dried_Bouquet,Mushroom);
	recipes[49].combos[43] = 	parseCombo(2,	Dried_Bouquet,Mystic_Egg);
	recipes[49].combos[44] = 	parseCombo(2,	Dried_Bouquet,Omelette_Meal);
	recipes[49].combos[45] = 	parseCombo(2,	Dried_Bouquet,Peach_Tart);
	recipes[49].combos[46] = 	parseCombo(2,	Dried_Bouquet,Peachy_Peach);
	recipes[49].combos[47] = 	parseCombo(2,	Dried_Bouquet,Poison_Shroom);
	recipes[49].combos[48] = 	parseCombo(2,	Dried_Bouquet,Shroom_Cake);
	recipes[49].combos[49] = 	parseCombo(2,	Dried_Bouquet,Shroom_Crepe);
	recipes[49].combos[50] = 	parseCombo(2,	Dried_Bouquet,Shroom_Fry);
	recipes[49].combos[51] = 	parseCombo(2,	Dried_Bouquet,Shroom_Roast);
	recipes[49].combos[52] = 	parseCombo(2,	Dried_Bouquet,Shroom_Steak);
	recipes[49].combos[53] = 	parseCombo(2,	Dried_Bouquet,Slow_Shroom);
	recipes[49].combos[54] = 	parseCombo(2,	Dried_Bouquet,Snow_Bunny);
	recipes[49].combos[55] = 	parseCombo(2,	Dried_Bouquet,Spaghetti);
	recipes[49].combos[56] = 	parseCombo(2,	Dried_Bouquet,Spicy_Pasta);
	recipes[49].combos[57] = 	parseCombo(2,	Dried_Bouquet,Spicy_Soup);
	recipes[49].combos[58] = 	parseCombo(2,	Dried_Bouquet,Super_Shroom);
	recipes[49].combos[59] = 	parseCombo(2,	Dried_Bouquet,Turtley_Leaf);
	recipes[49].combos[60] = 	parseCombo(2,	Dried_Bouquet,Ultra_Shroom);
	recipes[49].combos[61] = 	parseCombo(2,	Dried_Bouquet,Zess_Cookie);
	recipes[49].combos[62] = 	parseCombo(2,	Dried_Bouquet,Zess_Deluxe);
	recipes[49].combos[63] = 	parseCombo(2,	Dried_Bouquet,Zess_Dinner);
	recipes[49].combos[64] = 	parseCombo(2,	Dried_Bouquet,Zess_Frappe);
	recipes[49].combos[65] = 	parseCombo(2,	Dried_Bouquet,Zess_Special);
	recipes[49].combos[66] = 	parseCombo(2,	Dried_Bouquet,Zess_Tea);
	...
	recipes[50].combos[1] = 	parseCombo(2,	Trial_Stew,	Dried_Bouquet);
...
int checkRecipe(struct ItemCombination combo, int *makeableItems, int *outputsCreated, int *dependentIndices, struct Recipe *recipeList) {
	...
	for (int i = 0; i < combo.numItems; i++) {
		...
		if (outputsCreated[recipeIndex] || dependentIndices[recipeIndex]) {
...
void placeInventoryInMakeableItems(int *makeableItems, struct Inventory inventory) {
	for (int i = inventory.nulls; i < inventory.length; ++i) {
...
int stateOK(struct Inventory inventory, int *outputsCreated, struct Recipe *recipeList) {
	...
	for (int i = 0; i < NUM_RECIPES; i++) {
		...
		for (int j = 0; j < recipeList[i].countCombos; j++) {
			if (checkRecipe(recipeList[i].combos[j], makeableItems, outputsCreated, dependentIndices, recipeList) == 1) {
